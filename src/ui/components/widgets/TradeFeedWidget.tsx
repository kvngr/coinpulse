...
export const TradeFeedWidget = React.memo<TradeFeedWidgetProps>(
  ({ contractAddress, onRemove }) => {
    ...
    return (
      <Card className="relative flex max-h-96 min-h-0 flex-col overflow-y-auto p-6">
        {onRemove !== undefined ? (
          <button
            onClick={onRemove}
        ...
        <div className="absolute bottom-[70px] h-5 w-full bg-linear-to-b from-transparent to-gray-900" />
      </Card>
    );
  },
);
